/* ================================================================================================
 Requête de récupération de la structure de l'Hopital Européen Goerge Pompidou.
 ...
 European Hospital Georges Pompidou structure query
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "HORG-FR_HISTORY"."HEGP_structure" AS
WITH hospital AS (
...
CREATE UNIQUE INDEX "hegp_structure_idx01"
  ON "HORG-FR_HISTORY"."HEGP_structure" (dbid, supdbid);

CREATE UNIQUE INDEX "hegp_structure_idx02"
  ON "HORG-FR_HISTORY"."HEGP_structure" (dbid, supdbid, validTime);
