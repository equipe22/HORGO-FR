/* ================================================================================================
 Requête de récupération de la structure de l'Hopital Ambroise-Paré.
 ...
 Ambrois-Paré Hospital structure query
...
CREATE MATERIALIZED VIEW IF NOT EXISTS "HORG-FR_HISTORY"."HAP_structure" AS
WITH hospital AS (
...
CREATE UNIQUE INDEX "hap_structure_idx01"
  ON "HORG-FR_HISTORY"."HAP_structure" (dbid, supdbid);

CREATE UNIQUE INDEX "hap_structure_idx02"
  ON "HORG-FR_HISTORY"."HAP_structure" (dbid, supdbid, validTime);
